Add-Type -TypeDefinition (Get-Content (Join-Path $PSScriptRoot NativeConsole.cs) -Raw)
Add-Type -TypeDefinition (Get-Content (Join-Path $PSScriptRoot ConsoleDisplay.cs) -Raw)

[ConDraw.ConsoleDisplay]::new(10, 10).width
